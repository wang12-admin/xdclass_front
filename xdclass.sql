/*
 ...
 Source Schema         : xdclass

 Target Server Type    : MySQL
 Target Server Version : 50561
 File Encoding         : 65001

 Date: 13/01/2022 16:50:06
*/
...
CREATE TABLE `episode`  (
  ...
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 12630 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;

-- ----------------------------
-- Records of episode
-- ----------------------------
INSERT INTO `episode` VALUES (11000, '微信小程序课程介绍', 1, 1, 'xdclass.net/aaa.mp4', 370, 2, 40, '2022-01-08 16:15:25');
INSERT INTO `episode` VALUES (11001, '小程序是什么？小程序应用前景', 2, 2, 'xdclass.net/aaa.mp4', 370, 2, 40, '2022-01-08 16:15:25');
INSERT INTO `episode` VALUES (11002, '微信小程序的注册流程', 3, 3, 'xdclass.net/aaa.mp4', 370, 2, 40, '2022-01-08 16:15:25');
INSERT INTO `episode` VALUES (11003, '微信开发者工具安装及使用讲解', 4, 4, 'xdclass.net/aaa.mp4', 370, 1, 40, '2022-01-08 16:15:25');
INSERT INTO `episode` VALUES (11004, '小程序目录结构分析', 5, 5, 'xdclass.net/aaa.mp4', 370, 1, 40, '2022-01-08 16:15:25');
INSERT INTO `episode` VALUES (11005, '小程序配置文件分析', 6, 6, 'xdclass.net/aaa.mp4', 370, 1, 40, '2022-01-08 16:15:25');
INSERT INTO `episode` VALUES (11006, '新建一个小程序及框架组成介绍', 7, 1, 'xdclass.net/aaa.mp4', 371, 1, 40, '2022-01-08 16:15:25');
...
INSERT INTO `episode` VALUES (12101, 'Java新特性玩转JDK8~13课程大纲讲解', 1, 1, 'xdclass.net/aaa.mp4', 510, 0, 44, NULL);
INSERT INTO `episode` VALUES (12102, 'Java新特性之JDK8相关开发环境准备', 2, 2, 'xdclass.net/aaa.mp4', 510, 0, 44, NULL);
...
CREATE TABLE `play_record`  (
  ...
  `current_num` int(11) NULL DEFAULT NULL COMMENT '当前播放第⼏几集',
  `episode_id` int(11) NULL DEFAULT NULL COMMENT '当前播放第⼏几集视频id',
...
-- ----------------------------
INSERT INTO `play_record` VALUES (49, 56, 40, 1, 11000, '2022-01-11 17:19:45');
INSERT INTO `play_record` VALUES (50, 56, 41, 1, 11600, '2022-01-11 17:20:59');
INSERT INTO `play_record` VALUES (51, 56, 42, 1, 11690, '2022-01-11 17:21:06');
INSERT INTO `play_record` VALUES (52, 56, 43, 1, 11866, '2022-01-11 17:21:09');
INSERT INTO `play_record` VALUES (53, 56, 44, 1, 12101, '2022-01-11 17:21:13');
INSERT INTO `play_record` VALUES (54, 56, 45, 1, 12250, '2022-01-11 17:21:21');
INSERT INTO `play_record` VALUES (55, 56, 46, 1, 12350, '2022-01-11 17:21:25');
INSERT INTO `play_record` VALUES (56, 56, 47, 1, 12590, '2022-01-11 17:21:31');
...
CREATE TABLE `user`  (
  ...
  UNIQUE INDEX `phoneIndex`(`phone`) USING BTREE COMMENT '手机号唯一索引，不能重复数据'
) ENGINE = InnoDB AUTO_INCREMENT = 59 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;

-- ----------------------------
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (56, 'wang', 'C20AD4D76FE97759AA27A0C99BFF6710', 'https://xd-video-pc-img.oss-cn-beijing.aliyuncs.com/xdclass_pro/default/head_img/13.jpeg', '12', '2022-01-11 16:34:30');
INSERT INTO `user` VALUES (58, 'wang', '37693CFC748049E45D87B8C7D8B9AACD', 'https://xd-video-pc-img.oss-cn-beijing.aliyuncs.com/xdclass_pro/default/head_img/13.jpeg', '23', '2022-01-11 17:08:03');
...
CREATE TABLE `video`  (
  ...
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `c_id` int(10) NULL DEFAULT NULL COMMENT '子分类id',
...
INSERT INTO `video` VALUES (34, 'HTML5+CSS3前端开发教程flex布局项目实战', 'https://xd-video-pc-img.oss-cn-beijing.aliyuncs.com/xdclass_pro/video/2019_backend/html5_detail.jpeg', 'https://xd-video-pc-img.oss-cn-beijing.aliyuncs.com/xdclass_pro/video/2019_backend/html5.png', 3980, '2019-07-04 22:14:00', 16, 8.70);
...
INSERT INTO `video` VALUES (96, '小滴课堂面试专题900道1', '这个是面试专题概要1', NULL, 0, NULL, NULL, NULL);
INSERT INTO `video` VALUES (101, '小滴课堂 微服务架构', NULL, NULL, 0, NULL, NULL, NULL);
INSERT INTO `video` VALUES (102, '小滴课堂 微服务架构', NULL, NULL, 0, NULL, NULL, NULL);
INSERT INTO `video` VALUES (104, '小滴课堂 微服务架构', NULL, NULL, 0, NULL, NULL, NULL);
INSERT INTO `video` VALUES (105, '小滴课堂 微服务架构', NULL, NULL, 0, NULL, NULL, NULL);
INSERT INTO `video` VALUES (127, '事务测试标题3', NULL, NULL, 0, NULL, NULL, 0.00);
INSERT INTO `video` VALUES (129, '事务测试标题1001', NULL, NULL, 0, NULL, NULL, 0.00);
...
-- ----------------------------
INSERT INTO `video_banner` VALUES (1, 'https://m.xdclass.net/#/coursedetail?video_id=49', 'https://file.xdclass.net/video/2020/%E9%9D%A2%E8%AF%95%E4%B8%93%E9%A2%98/%E9%9D%A2%E8%AF%95%E4%B8%93%E9%A2%98%E7%AC%AC%E4%B8%80%E5%AD%A3banner.png', '2022-01-12 13:09:04', 1);
INSERT INTO `video_banner` VALUES (2, 'https://m.xdclass.net/#/member', 'https://file.xdclass.net/video/%E5%AE%98%E7%BD%91%E8%BD%AE%E6%92%AD%E5%9B%BE/%E8%BD%AE%E6%92%AD%E5%9B%BE-VIP.png', '2022-01-12 13:09:04', 2);
INSERT INTO `video_banner` VALUES (3, 'https://m.xdclass.net/#/coursedetail?video_id=48', 'https://file.xdclass.net/video/2020/c%E8%AF%AD%E8%A8%80/WechatIMG5.png', '2022-01-12 13:09:04', 3);
INSERT INTO `video_banner` VALUES (4, 'https://m.xdclass.net/#/coursedetail?video_id=47', 'https://file.xdclass.net/video/2020/node/node_banner.png', '2022-01-12 13:09:04', 4);
...
-- ----------------------------
INSERT INTO `video_order` VALUES (84, 'cf2f7c20-583c-478b-98c2-ae423333eac7', 1, '2022-01-11 17:19:45', 5980, 40, '全新微信小程序零基础到项目实战', 'https://xd-video-pc-img.oss-cn-beijing.aliyuncs.com/xdclass_pro/video/2019_frontend/%E5%B0%8F%E7%A8%8B%E5%BA%8F/wxapp.png', 56);
INSERT INTO `video_order` VALUES (89, '55f9a09e-6ca0-42c4-a169-32c206420c16', 1, '2022-01-11 17:20:59', 4880, 41, '玩转搜索框架ElasticSearch7.x实战', 'https://xd-video-pc-img.oss-cn-beijing.aliyuncs.com/xdclass_pro/video/2019_backend/elasticsearch7.png', 56);
INSERT INTO `video_order` VALUES (90, 'b50167be-ff9d-40c2-860a-4175aaf6917f', 1, '2022-01-11 17:21:06', 5980, 42, '全新elementUI项目实战教程Vue整合Echarts后台权限', 'https://xd-video-pc-img.oss-cn-beijing.aliyuncs.com/xdclass_pro/video/2019_frontend/element/elementui.png', 56);
INSERT INTO `video_order` VALUES (91, 'c5846f3e-234e-4eb0-b2d7-51cd288176e6', 1, '2022-01-11 17:21:09', 3980, 43, '19年Python3.7零基础入门到爬虫实战', 'https://xd-video-pc-img.oss-cn-beijing.aliyuncs.com/xdclass_pro/video/python/python.png', 56);
INSERT INTO `video_order` VALUES (92, 'bf4085fb-3f8e-4d94-97e2-b2d4099ef090', 1, '2022-01-11 17:21:13', 3980, 44, '2020版全新JDK8~JDK13全套新特性教程', 'https://xd-video-pc-img.oss-cn-beijing.aliyuncs.com/xdclass_pro/video/jdk8/jdk8.png', 56);
INSERT INTO `video_order` VALUES (93, '1097766f-152b-407f-95d6-3482fb85affd', 1, '2022-01-11 17:21:21', 5980, 45, 'Docker实战视频教程入门到高级dockerfile/compose-Harbor', 'https://xd-video-pc-img.oss-cn-beijing.aliyuncs.com/xdclass_pro/video/docker/docker.png', 56);
INSERT INTO `video_order` VALUES (94, 'f399a51f-3c2a-4c17-a26c-4621d074b5e8', 1, '2022-01-11 17:21:25', 3980, 46, '新版javase零基础到高级教程小白自学编程', 'https://xd-video-pc-img.oss-cn-beijing.aliyuncs.com/xdclass_pro/video/javase/javase.png', 56);
INSERT INTO `video_order` VALUES (95, '603a6a8d-8bcd-4d14-815a-c8e98417bde5', 1, '2022-01-11 17:21:31', 6980, 47, 'Nodejs教程零基础入门到项目实战前端视频教程', 'https://file.xdclass.net/video/2020/node/node.png', 56);
